...
if(isset($_POST['name'])){
	...
	$people = $db->prepare("SELECT ID, name, address, city, state, zip, phone, phone2, active FROM customer WHERE name LIKE '%$name%'"); 
	...
	while($people->fetch()){
		echo '<br>ID: ', $ID,
			...
			'<br>Phone: ', $phone, ' ----- Alternate PH: ', $phone2,
			'<br>Active: ', $active, '<br>';
	}
	
	echo "<br><hr><br>
			Enter the ID of the customer you would like to update<br>";
...
<html>
<body>
<form action="upcust3.php" method="post">
