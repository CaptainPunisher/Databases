...
<!-- DDDDDDDDDDDDDDDDDRRRRRRRRRRRRRR
...
<input type='submit' value='Add LABOR'>-->
<!--<button onclick=history.go(-1)>No, go back</button> -->
<!--DDDDDDDDDDDDDDDDDRRRRRRRRRRRRRR<input type='button' value='Finish Invoice' onclick="goHome()"/>
...
<input type='submit' value='Finish Invoice' />
