...
function addpartReturn($p){
	...
	global $db;
	$sql = "INSERT into parts(mfgr, part_no, description, superceded_by, price, f, sku)
		VALUES ('".$mfgr."', '".$part_no."', '".$description."', '".$superceded_by."', ".$price.", ".$f.", '".$sku."')"; //  replace $price with static value REMOVED SINGLE QUOTES FROM AROUND EACH VARIABLE
