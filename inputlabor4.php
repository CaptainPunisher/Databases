...
<input type='submit' value='Add LABOR'>-->
<!--<button onclick=history.go(-1)>No, go back</button> -->
<!--DDDDDDDDDDRRRRRRRRRRRRRR<input type='button' value='Finish Invoice' onclick="goHome()"/>

<script type="text/javascript" language="JavaScript">
	function goHome() {
		window.location = 'http://localhost/databases.php';
	}
</script>  DDDDDDDDDDRRRRRRRRRRRRRR-->
</form>   
...
<input type='submit' value='Finish Invoice' /><!--DDDDDDDDDDRRRRRRRRRRRRRR onclick="showInv()"/> DDDDDDDDDDRRRRRRRRRRRRRR-->
